...
gcov: testa_romanos.cpp   romanos.cpp romanos.hpp 
	g++ -std=c++17 -Wall -Wall -fprofile-arcs -ftest-coverage -c romanos.cpp
	g++ -std=c++17 -Wall -fprofile-arcs -ftest-coverage romanos.o testa_romanos.cpp -o testa_romanos
	./testa_romanos
	gcov *.cpp	
	
debug: testa_romanos.cpp   romanos.cpp romanos.hpp 
	g++ -std=c++17 -Wall -Wall -g -c romanos.cpp
	g++ -std=c++17 -Wall  -g romanos.o testa_romanos.cpp -o testa_romanos
	gdb testa_romanos
...
romanos.o : romanos.cpp romanos.hpp
	g++ -std=c++17 -Wall -Wall -c romanos.cpp
